...
class SeqCrypt:
    ...
    def encrypt(self, plaintext: bytes) -> bytes:
        ...
        self.seq = seq + 2
        self.log.debug(f"encrypt: seq={seq} nonce={nonce.hex()} ciphertext={ciphertext.hex()} trailer={trailer.hex()}")
